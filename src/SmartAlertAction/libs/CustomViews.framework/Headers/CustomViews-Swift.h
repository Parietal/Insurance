...
SWIFT_CLASS("_TtC11CustomViews17CircularImageView")
@interface CircularImageView : UIView
@property (nonatomic) UIImage * image;
- (void)setImageAsURL:(NSString *)imageURL;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC11CustomViews17CircularMeterView")
...
SWIFT_CLASS("_TtC11CustomViews14StarRatingView")
